...
--Дополнительно можно построить индексы на все внешние ключи в таблице Document_Rubric, на Rubric.Name - так как основная группировка ведется по этому полю
